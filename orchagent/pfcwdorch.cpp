        ...
        try
        {
            ...
            else if (field == PFC_WD_ACTION)
            {
                ...
                if(m_platform == BRCM_PLATFORM_SUBSTRING)
                {
                    ...
                    {
                        if(checkPfcDlrPacketAction() == PfcWdAction::PFC_WD_ACTION_UNKNOWN) 
                        {
                        ...
                        {
                            if(checkPfcDlrPacketAction() != action) 
                            {
                                SWSS_LOG_ERROR("Invalid PFC Watchdog action %s as switch level action is set", value.c_str());
                                return task_process_status::task_invalid_entry;
                            }
                        }
